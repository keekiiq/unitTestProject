...
onSave() {
  ...
  this.courses[this.selectedRow].title = this.regModel.title;
...
// It maintains Array of countries.
  ...
  constructor() {
    ...
    this.courses.push(new Course('953392',' Software engineering preproject','701','3','Mo','08.00-9.00','CAMT218','50','Software Engineering project preparation. Literature review technique. Feasibility study. Project proposal development. Proposal presentation. Grading will be given on satisfactory or unsatisfactory basis.')),
